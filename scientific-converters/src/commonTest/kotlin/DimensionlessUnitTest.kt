...
import com.splendo.kaluga.scientific.unit.Percent
import com.splendo.kaluga.scientific.unit.Permill
...
class DimensionlessUnitTest {
    ...
    @Test
    fun dimensionlessFromTimeAndFrequency() {
        assertEquals(4.0, (2(Hertz) * 2(Second)).toDouble())
        assertEquals(4.0, (2(Second) * 2(Hertz)).toDouble())
    }
}
