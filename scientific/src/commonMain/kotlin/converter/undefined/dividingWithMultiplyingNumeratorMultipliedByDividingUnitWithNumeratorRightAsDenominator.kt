...
) = unit.numerator.left.leftNumeratorLeftUnitXRightNumeratorUnit(right.unit.numerator).targetNumeratorUnitPerLeftDenominatorUnit(unit.denominator).byMultiplying(this, right, factory)
