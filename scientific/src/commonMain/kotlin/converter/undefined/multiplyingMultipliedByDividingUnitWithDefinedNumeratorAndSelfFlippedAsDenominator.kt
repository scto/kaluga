...
fun <
    ...
    > UndefinedScientificValue<UndefinedQuantityType.Multiplying<LeftLeftAndRightDenominatorRightQuantity, LeftRightAndRightDenominatorLeftQuantity>, LeftUnit>.multipliedByDividingUnitWithDefinedNumeratorAndSelfFlippedAsDenominator(
    right:
...
infix fun <
    ...
    multipliedByDividingUnitWithDefinedNumeratorAndSelfFlippedAsDenominator(right) {
            value: Decimal,
