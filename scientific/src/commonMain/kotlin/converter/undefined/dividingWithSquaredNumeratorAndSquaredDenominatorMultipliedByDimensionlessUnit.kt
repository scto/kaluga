...
// Div<Mul<A, A>, Mul<B, B>> * One -> Div<Mul<A, A>, Mul<B, B>>

@JvmName("dividingWithSquaredNumeratorAndSquaredDenominatorMultipliedByDimensionlessUnit")
fun <
...
) = unit.byMultiplying(this, right, factory)
