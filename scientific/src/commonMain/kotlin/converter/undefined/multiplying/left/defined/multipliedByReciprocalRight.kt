...
package com.splendo.kaluga.scientific.converter.undefined.multiplying.left.defined
...
fun <
	...
	> UndefinedScientificValue<UndefinedQuantityType.Multiplying<UndefinedQuantityType.Extended<LeftLeftQuantity>, LeftRightAndRightReciprocalQuantity>, LeftUnit>.multipliedByReciprocalRight(
...
@JvmName("metricAndImperialMultipliedByMetricAndImperialReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
	...
	multipliedByReciprocalRight(right) {
		value: Decimal,
		unit: LeftLeftUnit
		->
...
@JvmName("metricMultipliedByMetricReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("imperialMultipliedByImperialReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("ukImperialMultipliedByUKImperialReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("usCustomaryMultipliedByUSCustomaryReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("metricAndUKImperialMultipliedByMetricAndUKImperialReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("metricAndUSCustomaryMultipliedByMetricAndUSCustomaryReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit,
	WrappedLeftLeftUnit,
...
@JvmName("genericMultipliedByGenericReciprocalRight")
infix operator fun <
	LeftLeftQuantity : PhysicalQuantity.DefinedPhysicalQuantityWithDimension,
	LeftLeftUnit : AbstractScientificUnit<LeftLeftQuantity>,
	WrappedLeftLeftUnit : WrappedUndefinedExtendedUnit<LeftLeftQuantity, LeftLeftUnit>,
