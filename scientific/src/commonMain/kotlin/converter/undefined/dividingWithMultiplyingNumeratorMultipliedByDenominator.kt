...
// Div<Mul<A, B>, C> * C -> Mul<B, A>

@JvmName("dividingWithMultiplyingNumeratorMultipliedByDenominator")
fun <
...
RightUnit,
	>,
	leftNumeratorRightUnitXLeftNumeratorLeftUnit: LeftNumeratorRightUnit.(LeftNumeratorLeftUnit) -> TargetUnit,
