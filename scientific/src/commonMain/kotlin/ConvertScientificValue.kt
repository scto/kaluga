...
/**
 * Converts a [ScientificValue] into a [DefaultScientificValue] with an [DefinedScientificUnit] of the same [PhysicalQuantity]
 ...
 * @param Unit the type of [DefinedScientificUnit] of the current [ScientificValue]
