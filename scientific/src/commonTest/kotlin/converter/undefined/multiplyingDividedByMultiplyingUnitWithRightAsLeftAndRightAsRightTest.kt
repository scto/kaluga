...
class MultiplyingDividedByMultiplyingUnitWithRightAsLeftAndRightAsRightTest {

    @Test
    fun dividedByMultiplyingUnitWithRightAsLeftAndRightAsRight() {
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.MetricAndImperial.undefinedB x UndefinedConverterUnits.MetricAndImperial.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.Metric.undefinedB x UndefinedConverterUnits.Metric.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.Imperial.undefinedB x UndefinedConverterUnits.Imperial.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.UKImperial.undefinedB x UndefinedConverterUnits.UKImperial.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.USCustomary.undefinedB x UndefinedConverterUnits.USCustomary.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.MetricAndUKImperial.undefinedB x UndefinedConverterUnits.MetricAndUKImperial.undefinedB))
        // )
        // assertEquals(
        ...
        // 		2((UndefinedConverterUnits.MetricAndUSCustomary.undefinedB x UndefinedConverterUnits.MetricAndUSCustomary.undefinedB))
        // )
    }
}
