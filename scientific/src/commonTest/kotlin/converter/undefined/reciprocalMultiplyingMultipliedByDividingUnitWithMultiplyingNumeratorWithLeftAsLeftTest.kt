...
class ReciprocalMultiplyingMultipliedByDividingUnitWithMultiplyingNumeratorWithLeftAsLeftTest {

    @Test
    fun multipliedByDividingUnitWithMultiplyingNumeratorWithLeftAsLeft() {
        // assertEquals(
