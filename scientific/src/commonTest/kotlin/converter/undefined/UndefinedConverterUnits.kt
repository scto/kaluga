...
import com.splendo.kaluga.scientific.unit.CustomUndefinedExtendedUnit

object UndefinedConverterUnits {
    object MetricAndImperial {
        val undefinedA = CustomUndefinedExtendedUnit.MetricAndImperial(
    ...
    object Metric {
        val undefinedA = CustomUndefinedExtendedUnit.Metric(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
    ...
    object Imperial {
        val undefinedA = CustomUndefinedExtendedUnit.Imperial(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
    ...
    object UKImperial {
        val undefinedA = CustomUndefinedExtendedUnit.UKImperial(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
    ...
    object USCustomary {
        val undefinedA = CustomUndefinedExtendedUnit.USCustomary(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
    ...
    object MetricAndUKImperial {
        val undefinedA = CustomUndefinedExtendedUnit.MetricAndUKImperial(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
    ...
    object MetricAndUSCustomary {
        val undefinedA = CustomUndefinedExtendedUnit.MetricAndUSCustomary(
            PhysicalQuantity.Length,
            siFactor = 2.0,
            siOffset = 0.0,
            symbol = "A",
