...
class MultiplyingDividedByDividingUnitWithMultiplyingNumeratorWithLeftAsLeftAndRightAsLeftTest {

	@Test
	fun dividedByDividingUnitWithMultiplyingNumeratorWithLeftAsLeftAndRightAsLeft() {
		// assertEquals(
