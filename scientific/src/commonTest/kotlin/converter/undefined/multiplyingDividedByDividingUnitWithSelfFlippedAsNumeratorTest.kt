...
class MultiplyingDividedByDividingUnitWithSelfFlippedAsNumeratorTest {

	@Test
	fun dividedByDividingUnitWithSelfFlippedAsNumerator() {
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.MetricAndImperial.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.Metric.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.Imperial.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.UKImperial.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.USCustomary.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.MetricAndUKImperial.undefinedC),
		...
		// )
		// assertEquals(
		// 	1.0(UndefinedConverterUnits.MetricAndUSCustomary.undefinedC),
