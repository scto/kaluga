...
class DividingMultipliedByDividingUnitWithMultiplyingDenominatorWithNumeratorAsLeftTest {

	@Test
	fun multipliedByDividingUnitWithMultiplyingDenominatorWithNumeratorAsLeft() {
		// assertEquals(
