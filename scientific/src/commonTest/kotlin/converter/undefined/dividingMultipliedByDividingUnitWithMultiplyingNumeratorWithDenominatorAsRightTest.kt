...
class DividingMultipliedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightTest {

	@Test
	fun multipliedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRight() {
		// assertEquals(
