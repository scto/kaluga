...
// Div<A, Mul<B, B>> / Div<C, Mul<B, D>> -> Div<Mul<A, D>, Mul<B, C>>

class DivWSquaredDenomDividedByDivUnitWMulDenomWDenomRootAsLTest {

	@Test
	fun dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRootAsLeft() {
		// assertEquals(
