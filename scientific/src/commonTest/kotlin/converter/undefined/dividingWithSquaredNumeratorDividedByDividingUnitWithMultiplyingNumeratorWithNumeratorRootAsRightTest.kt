...
class DividingWithSquaredNumeratorDividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRootAsRightTest {

	@Test
	fun dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRootAsRight() {
		// assertEquals(
