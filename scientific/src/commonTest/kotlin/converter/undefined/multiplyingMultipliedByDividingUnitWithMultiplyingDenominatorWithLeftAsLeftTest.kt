...
class MultiplyingMultipliedByDividingUnitWithMultiplyingDenominatorWithLeftAsLeftTest {

    @Test
    fun multipliedByDividingUnitWithMultiplyingDenominatorWithLeftAsLeft() {
        // assertEquals(
