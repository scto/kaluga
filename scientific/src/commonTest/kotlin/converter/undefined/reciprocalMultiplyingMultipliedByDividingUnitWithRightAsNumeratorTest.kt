...
class ReciprocalMultiplyingMultipliedByDividingUnitWithRightAsNumeratorTest {
	...
	fun multipliedByDividingUnitWithRightAsNumerator() {
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.MetricAndImperial.undefinedA x UndefinedConverterUnits.MetricAndImperial.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.Metric.undefinedA x UndefinedConverterUnits.Metric.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.Imperial.undefinedA x UndefinedConverterUnits.Imperial.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.UKImperial.undefinedA x UndefinedConverterUnits.UKImperial.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.USCustomary.undefinedA x UndefinedConverterUnits.USCustomary.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.MetricAndUKImperial.undefinedA x UndefinedConverterUnits.MetricAndUKImperial.undefinedC).reciprocal()),
		...
		// )
		// assertEquals(
		// 	4.0((UndefinedConverterUnits.MetricAndUSCustomary.undefinedA x UndefinedConverterUnits.MetricAndUSCustomary.undefinedC).reciprocal()),
