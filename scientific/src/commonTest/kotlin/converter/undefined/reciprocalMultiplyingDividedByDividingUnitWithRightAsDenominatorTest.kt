...
class DividedByDividingUnitWithRightAsDenominatorTest {

	@Test
	fun dividedByDividingUnitWithRightAsDenominator() {
		assertEquals(
			1((UndefinedConverterUnits.MetricAndImperial.undefinedA x UndefinedConverterUnits.MetricAndImperial.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.Metric.undefinedA x UndefinedConverterUnits.Metric.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.Imperial.undefinedA x UndefinedConverterUnits.Imperial.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.UKImperial.undefinedA x UndefinedConverterUnits.UKImperial.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.USCustomary.undefinedA x UndefinedConverterUnits.USCustomary.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.MetricAndUKImperial.undefinedA x UndefinedConverterUnits.MetricAndUKImperial.undefinedC).reciprocal()),
		...
		assertEquals(
			1((UndefinedConverterUnits.MetricAndUSCustomary.undefinedA x UndefinedConverterUnits.MetricAndUSCustomary.undefinedC).reciprocal()),
