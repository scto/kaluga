...
class DividedByDividingUnitWithMultiplyingNumeratorWithSelfAsRightTest {
	...
	fun dividedByDividingUnitWithMultiplyingNumeratorWithSelfAsRight() {
		assertEquals(
			1((UndefinedConverterUnits.MetricAndImperial.undefinedC per UndefinedConverterUnits.MetricAndImperial.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.Metric.undefinedC per UndefinedConverterUnits.Metric.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.Imperial.undefinedC per UndefinedConverterUnits.Imperial.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.UKImperial.undefinedC per UndefinedConverterUnits.UKImperial.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.USCustomary.undefinedC per UndefinedConverterUnits.USCustomary.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.MetricAndUKImperial.undefinedC per UndefinedConverterUnits.MetricAndUKImperial.undefinedB)),
		...
		assertEquals(
			1((UndefinedConverterUnits.MetricAndUSCustomary.undefinedC per UndefinedConverterUnits.MetricAndUSCustomary.undefinedB)),
