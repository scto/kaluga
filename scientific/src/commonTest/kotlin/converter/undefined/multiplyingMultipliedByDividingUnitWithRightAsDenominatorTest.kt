...
class MultiplyingMultipliedByDividingUnitWithRightAsDenominatorTest {
	...
	fun multipliedByDividingUnitWithRightAsDenominator() {
		assertEquals(
			4((UndefinedConverterUnits.MetricAndImperial.undefinedB x UndefinedConverterUnits.MetricAndImperial.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.Metric.undefinedB x UndefinedConverterUnits.Metric.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.Imperial.undefinedB x UndefinedConverterUnits.Imperial.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.UKImperial.undefinedB x UndefinedConverterUnits.UKImperial.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.USCustomary.undefinedB x UndefinedConverterUnits.USCustomary.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.MetricAndUKImperial.undefinedB x UndefinedConverterUnits.MetricAndUKImperial.undefinedC)),
		...
		assertEquals(
			4((UndefinedConverterUnits.MetricAndUSCustomary.undefinedB x UndefinedConverterUnits.MetricAndUSCustomary.undefinedC)),
