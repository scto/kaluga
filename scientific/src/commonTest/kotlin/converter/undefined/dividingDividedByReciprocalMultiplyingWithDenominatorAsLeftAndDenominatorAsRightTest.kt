...
class DividingDividedByReciprocalMultiplyingWithDenominatorAsLeftAndDenominatorAsRightTest {

    @Test
    fun dividedByReciprocalMultiplyingWithDenominatorAsLeftAndDenominatorAsRight() {
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.MetricAndImperial.undefinedA x UndefinedConverterUnits.MetricAndImperial.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.Metric.undefinedA x UndefinedConverterUnits.Metric.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.Imperial.undefinedA x UndefinedConverterUnits.Imperial.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.UKImperial.undefinedA x UndefinedConverterUnits.UKImperial.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.USCustomary.undefinedA x UndefinedConverterUnits.USCustomary.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.MetricAndUKImperial.undefinedA x UndefinedConverterUnits.MetricAndUKImperial.undefinedB)),
        ...
        // )
        // assertEquals(
        // 	1.0((UndefinedConverterUnits.MetricAndUSCustomary.undefinedA x UndefinedConverterUnits.MetricAndUSCustomary.undefinedB)),
